  ...
  return (
    <>
     <div className="mx-5 md:mx-0 md:justify-end md:flex md:flex-row md:my-10">
          <p className="tracking-wider lg:basis-2/3 xl:basis-1/3	font-titles bg-gradient-to-t from-accent-900 to-accent-50  bg-clip-text text-transparent underline underline-offset-4 decoration-3  decoration-accent-900 text-xl my-3 sm:text-3xl md:text-center md:w-full md:m-0 lg:text-4xl 2xl:text-5xl">About Me</p>
          <Typography variant="small" className="font-body text-body text-xs md:mr-5 sm:text-base xl:mr-16">
